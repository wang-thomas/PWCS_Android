package com.whartonsummit.android_app.pwcs_android.Fragments.Timelines;
...
public class Day3Fragment extends TimelineFragment{
    ...
    private List<TimelineObj> prepareData() {
        return DataService.getInstance().getScheduleForDay(3);
    }
}
