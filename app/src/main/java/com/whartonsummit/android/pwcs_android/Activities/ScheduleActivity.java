...
import com.whartonsummit.android.pwcs_android.Fragments.Timelines.Day1Fragment;
import com.whartonsummit.android.pwcs_android.Fragments.Timelines.Day2Fragment;
import com.whartonsummit.android.pwcs_android.Fragments.Timelines.Day3Fragment;
...
public class ScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new FragmentPagerItemAdapter(
                ...
                .add("Friday 19", Day1Fragment.class)
                .add("Saturday 20", Day2Fragment.class)
                .add("Sunday 21", Day3Fragment.class)
                .create());
